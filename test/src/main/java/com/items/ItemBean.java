...
public class ItemBean {
	...
	public int getVendorListSize(){
		System.out.println(VendorItemList.size()+" Size");
	...
	public void createPurchaseOrder(int vendor_Id, String iCode, double iCost, int orderQty){
		...
		try{
			...
			PurchaseOrder(purchaseOrder);
			   ...
			   System.out.println("Error while Creating Purchase Order: "+nfe.getMessage());
			   nfe.printStackTrace();
		}
	}
	
	public void PurchaseOrder(ItemsDescription cartItem) {
		purchaseOrder.add(cartItem);
	}
	public ArrayList<ItemsDescription> getpurchaseOrder() {
		//System.out.println(itemList);  
		return purchaseOrder;
		 }
	 public void setpurchaseOrder(ArrayList<ItemsDescription> alVendorItems) {
		  this.purchaseOrder = alVendorItems;
		 }
	 public void clearPurchaseOrder(){
			this.purchaseOrder.clear();
			
			purchaseOrder = new ArrayList<ItemsDescription>();
		}
...
public ArrayList<ItemsDescription> getVendorItemList() {
 ...
 public void clearVendorItem(){
		...
		VendorItemList = new ArrayList<ItemsDescription>();
	}
}
