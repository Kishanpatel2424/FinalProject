...
<div class="container-center">
	<form id="MyForm" name="MyForm" action="cashier" method="POST" >
	...
	<table class="table" id="item" >
		<tr>
			...
			<th style="width:10%;">
				Print Reciept<br>
				<a href ="/test/Invoice_${maxInvNum}.pdf" target="_blank"><input type="button" Value="Reciept" name="Reciept" class="form-control"></a>
		...
		<tr>
			...
			<th style="width:15%;">
				...
				<button type="button" class=" form-control">
      				<span class="glyphicon glyphicon-search"></span><a href="/test/SearchList.jsp"> Search
   				 </button>
			</th>
			<th style="width:10%;">
				Sale Reciepts:-
