...
<div class="container-center">
	<form id="MyForm" name="MyForm" action="cashierR" method="POST" >
	...
	<table class="table" id="item" >
		<tr>
			...
			<th style="width:10%;">
				...
				<br>
				<a href="/test/PayPage.jsp"><input type="button" Value="Pay" name="Pay" class="form-control"></a>
			</th>
			...
			<th style="width:10%;">
				Print Reciept<br>
				<a href ="/test/LastReciept.jsp" target="_blank"><input type="button" Value="Reciept" name="Reciept" class="form-control"></a>
	...
	<table class="table" id ="bottom">
		<tr >
			...
			<th style="width:15%;">
				<!-- <button class="form-control"><a href="/test/SearchList.jsp">Search Item</a></button> -->
				Search Item:-<br>
				
      				<a href="/test/SearchList.jsp"><input type="button" Value="Search Item" name="SearchItem" class="form-control">
      				</a>
